...
package net.firejack.platform.web.security.exception;

import net.firejack.platform.core.exception.OpenFlameRuntimeException;

public class SecurityRuntimeException extends OpenFlameRuntimeException {

    private static final long serialVersionUID = 7081736829769314180L;
