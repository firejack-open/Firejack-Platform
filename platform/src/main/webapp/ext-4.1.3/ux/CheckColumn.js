...
Ext.define('Ext.ux.CheckColumn', {
    ...
    processEvent: function(type, view, cell, recordIndex, cellIndex, e) {
        if (type == 'mousedown' || (type == 'keydown' && (e.getKey() == e.ENTER || e.getKey() == e.SPACE))) {
            this.processCheckEvent(type, view, cell, recordIndex, cellIndex, e);
            return false;
        } else {
    ...
    processCheckEvent: function(type, view, cell, recordIndex, cellIndex, e) {
    ...
    renderer : function(value){
        return Ext.ux.CheckColumn.renderer(value);
    }
});