...
public interface IModelGeneratorService extends ICacheService {
    /**
     * @param descriptor
     * @param structure
     * @return
     ...
     */
    List<Model> generateModels(IPackageDescriptor descriptor, Structure structure) throws IOException;
}
