...
public interface IDomainGeneratorService extends ICacheService {
    /**
     * @param models
     * @param structure
     ...
     */
    void generateDomains(List<Model> models, Structure structure) throws ParseException, IOException;
}
