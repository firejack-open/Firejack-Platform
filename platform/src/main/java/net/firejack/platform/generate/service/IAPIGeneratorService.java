...
public interface IAPIGeneratorService extends ICacheService {
    Api generateAPIService(IPackageDescriptor descriptor, List<Model> models, String url, Structure structure) throws IOException;
}
