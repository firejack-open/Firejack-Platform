...
@Properties(suffix = "ServiceProxy")
public class ProxyService extends LocalService {

    public ProxyService(Service service, List<Method> methods) {
        super(service, methods);
    }
}
