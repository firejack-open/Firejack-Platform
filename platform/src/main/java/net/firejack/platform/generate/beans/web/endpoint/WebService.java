...
@Properties(subpackage = "endpoint", prefix = "I")
public class WebService extends Interface {

    public WebService(Endpoint endpoint) {
        super(endpoint, endpoint.getLocal().getMethods());
    }
}
