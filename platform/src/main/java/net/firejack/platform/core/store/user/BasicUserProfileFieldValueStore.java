...
@Component("userProfileFieldValueStore")
public class BasicUserProfileFieldValueStore extends UIDStore<UserProfileFieldValueModel, Long> implements IUserProfileFieldValueStore {
