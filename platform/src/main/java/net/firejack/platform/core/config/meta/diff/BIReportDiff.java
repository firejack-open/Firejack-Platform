...
public class BIReportDiff extends PackageDescriptorElementDiff
        <IPackageDescriptorElement, BIReportElement> {

    /**
     * @param added
     * @param reportElement
     */
    public BIReportDiff(Boolean added, BIReportElement reportElement) {
     ...
     * @param newReport
     */
    public BIReportDiff(BIReportElement oldReport, BIReportElement newReport) {
