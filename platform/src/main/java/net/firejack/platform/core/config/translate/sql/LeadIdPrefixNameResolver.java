...
public class LeadIdPrefixNameResolver extends DefaultSqlNameResolver {

    public static final String ID_PARENT = "id_parent";

    @Override
    public String resolveReferenceColumn(String referencedTable) {
        return ID_PREFIX + StringUtils.changeWhiteSpacesWithSymbol(referencedTable, TOKEN_UNDERSCORE).toLowerCase();
    }
