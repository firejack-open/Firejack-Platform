...
public class DuplicateLookupException extends OpenFlameRuntimeException {

    private static final long serialVersionUID = -4241843855238118206L;

    /***/
    public DuplicateLookupException() {
    }
