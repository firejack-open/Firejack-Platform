...
public interface ISqlSupport {
     ...
     * @return
     */
    ForeignKeyProcessor addOnUpdateSection(ForeignKeyProcessor fkProcessor, RelationshipOption option);
     ...
     * @return
     */
    ForeignKeyProcessor addOnDeleteSection(ForeignKeyProcessor fkProcessor, RelationshipOption option);
