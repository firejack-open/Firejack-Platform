...
public class ActorsDiff extends PackageDescriptorElementDiff
        <IPackageDescriptorElement, ActorElement> {

    /**
     * @param oldElement
     * @param newElement
     */
    public ActorsDiff(ActorElement oldElement, ActorElement newElement) {
     ...
     * @param element
     */
    public ActorsDiff(Boolean added, ActorElement element) {
        super(added, element);
    }
