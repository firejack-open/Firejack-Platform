...
public class ConfigSourceException extends OpenFlameException {

    private static final long serialVersionUID = 8601092370697266252L;
     ...
     * @param cause
     */
    public ConfigSourceException(Throwable cause) {
        super(cause);
    }
