...
public class ResourceLocationsDiff extends
        PackageDescriptorElementDiff<IPackageDescriptorElement, ResourceLocationElement> {

    /**
     * @param oldElement
     * @param newElement
     */
    public ResourceLocationsDiff(ResourceLocationElement oldElement, ResourceLocationElement newElement) {
     ...
     * @param upgradeTarget
     */
    public ResourceLocationsDiff(Boolean added, ResourceLocationElement upgradeTarget) {
