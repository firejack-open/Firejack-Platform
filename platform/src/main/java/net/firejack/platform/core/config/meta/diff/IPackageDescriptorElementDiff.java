...
import net.firejack.platform.core.config.meta.IArgumentProvider;
import net.firejack.platform.core.config.meta.IPackageDescriptorElement;


public interface IPackageDescriptorElementDiff
        <P extends IPackageDescriptorElement, T extends IPackageDescriptorElement>
        extends IArgumentProvider, IDiffTypeContainer {
