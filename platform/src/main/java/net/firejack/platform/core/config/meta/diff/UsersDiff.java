...
public class UsersDiff extends PackageDescriptorElementDiff
        <IPackageDescriptorElement, UserElement> {

    /**
     * @param added
     * @param element
     */
    public UsersDiff(Boolean added, UserElement element) {
        super(added, element);
    }
     ...
     * @param newElement
     */
    public UsersDiff(UserElement oldElement, UserElement newElement) {
