...
public class GroupElement extends PackageDescriptorElement<GroupModel> {
    ...
    @Override
    public Class<GroupModel> getEntityClass() {
    ...
    public boolean equals(Object o) {
        ...
        return !(directoryRef != null ?
                !directoryRef.equals(that.directoryRef) : that.directoryRef != null);
    ...
    public int hashCode() {
        ...
        result = 31 * result + (directoryRef != null ? directoryRef.hashCode() : 0);
        return result;
    }
}