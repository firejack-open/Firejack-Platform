...
public class ActionsDiff extends PackageDescriptorElementDiff<IPackageDescriptorElement, ActionElement> {

    /**
     * @param oldElement
     * @param newElement
     */
    public ActionsDiff(ActionElement oldElement, ActionElement newElement) {
     ...
     * @param upgradeTarget
     */
    public ActionsDiff(Boolean added, ActionElement upgradeTarget) {
