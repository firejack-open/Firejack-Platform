...
public interface IPackageDescriptorElementSqlDecorator<T extends IPackageDescriptorElement> {
     ...
     * @return
     */
    T decorateElement(T element, ISqlHandler sqlHandler, EntityElementManager entityManager);
