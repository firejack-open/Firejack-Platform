...
public interface IIndexStore extends ILookupStore<IndexModel, Long> {

    List<IndexModel> findIndexesByEntityId(Long entityId);

    void deleteAllByEntityId(Long entityId);

    IndexModel findIndexByRelationship(Long relationshipId);

    void createOrUpdateIndex(RelationshipModel relationshipModel);
