...
@TrackDetails
@Component("readSystemUserListByRegistryNodeBroker")
public class ReadSystemUserListByRegistryNodeBroker extends ReadBaseUserListByRegistryNodeBroker<SystemUserModel, SystemUser> {
    ...
    @Override
    protected IBaseUserStore<SystemUserModel> getStore() {
        return store;
    }
