...
@Component("deleteHtmlResourceBroker")
@TrackDetails
public class DeleteHtmlResourceBroker
        extends AbstractDeleteResourceBroker<HtmlResourceModel> {
    ...
    @Override
    protected IResourceStore<HtmlResourceModel> getStore() {
        return store;
    }

    @Override
    protected String getSuccessMessage() {
        return "Html resource has deleted successfully";
    }
