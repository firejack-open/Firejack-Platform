...
@Component("readVideoResourceByIdBroker")
@TrackDetails
public class ReadVideoResourceByIdBroker
        extends AbstractReadResourceByIdBroker<VideoResourceModel, VideoResourceVersionModel, VideoResource> {
