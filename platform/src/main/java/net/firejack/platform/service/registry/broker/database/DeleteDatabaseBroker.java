...
@TrackDetails
@Component("deleteDatabaseBroker")
public class DeleteDatabaseBroker extends DeleteAliasableBroker<DatabaseModel> {
	...
	protected String getSuccessMessage() {
		return "Database has deleted successfully";
	}

	@Override
	protected IRegistryNodeStore<DatabaseModel> getStore() {
		return store;
	}
