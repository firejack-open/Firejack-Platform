...
@TrackDetails
@Component("readUserProfileFieldBroker")
public class ReadUserProfileFieldBroker
        extends ReadBroker<UserProfileFieldModel, UserProfileField> {
	...
	@Override
	protected UserProfileFieldModel getEntity(Long id) {
		return store.findById(id, false);
	}
}
