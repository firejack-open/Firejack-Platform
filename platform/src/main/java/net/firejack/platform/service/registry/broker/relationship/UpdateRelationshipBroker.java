...
@TrackDetails
@Component("UpdateRelationshipBroker")
@Changes("'Relationship '+ name +' has been updated'")
public class UpdateRelationshipBroker extends OPFSaveBroker<RelationshipModel, Relationship, RegistryNodeTree> {
	...
	protected String getSuccessMessage(boolean isNew) {
		return "Relationship has been updated successfully.";
	}
