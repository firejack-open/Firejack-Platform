...
@Component("deleteVideoResourceBroker")
@TrackDetails
public class DeleteVideoResourceBroker
        extends AbstractDeleteResourceBroker<VideoResourceModel> {
    ...
    @Override
    protected IResourceStore<VideoResourceModel> getStore() {
        return store;
    }

    @Override
    protected String getSuccessMessage() {
        return "Video resource has deleted successfully";
    }
