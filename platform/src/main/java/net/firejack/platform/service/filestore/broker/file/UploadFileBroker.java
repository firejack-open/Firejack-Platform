...
/**
 * Class encapsulates updating the file functionality
 */
@Component
@TrackDetails
public class UploadFileBroker extends ServiceBroker<ServiceRequest<NamedValues>, ServiceResponse> {
	...
	protected ServiceResponse perform(ServiceRequest<NamedValues> request) throws Exception {
		...
		fileStore.upload(inputStream, path);

		return new ServiceResponse("File added successfully.", true);
	}
}