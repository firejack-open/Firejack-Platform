...
@TrackDetails
@Component("deleteRelationshipBroker")
public class DeleteRelationshipBroker extends DeleteRegistryNodeBroker<RelationshipModel> {
	...
	protected String getSuccessMessage() {
		return "Relationship has deleted successfully";
	}

	@Override
	protected IStore<RelationshipModel, Long> getStore() {
		return store;
	}
