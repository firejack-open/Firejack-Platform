...
/**
 * Class encapsulates the functionality of process deletion
 */
@TrackDetails
@Component("deleteProcessBroker")
public class DeleteProcessBroker extends DeleteRegistryNodeBroker<ProcessModel> {
