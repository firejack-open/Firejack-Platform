...
@Component("deleteAudioResourceVersionBroker")
@TrackDetails
public class DeleteAudioResourceVersionBroker
        extends AbstractDeleteResourceVersionBroker<AudioResourceModel, AudioResourceVersionModel, AudioResource> {
