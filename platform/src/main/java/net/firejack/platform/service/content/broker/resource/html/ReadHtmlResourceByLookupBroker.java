...
@Component("readHtmlResourceByLookupBroker")
@TrackDetails
public class ReadHtmlResourceByLookupBroker
        extends AbstractReadResourceByLookupBroker<HtmlResourceModel, HtmlResourceVersionModel, HtmlResource> {

    @Autowired
    @Qualifier("htmlResourceStore")
    private IResourceStore<HtmlResourceModel> resourceStore;

    @Autowired
    @Qualifier("htmlResourceVersionStore")
    private IResourceVersionStore<HtmlResourceVersionModel> resourceVersionStore;
