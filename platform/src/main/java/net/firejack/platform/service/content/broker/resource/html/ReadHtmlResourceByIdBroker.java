...
@Component("readHtmlResourceByIdBroker")
@TrackDetails
public class ReadHtmlResourceByIdBroker
        extends AbstractReadResourceByIdBroker<HtmlResourceModel, HtmlResourceVersionModel, HtmlResource> {
