...
@TrackDetails
@Component("readDomainListBroker")
public class ReadDomainListBroker extends ReadAllBroker<DomainModel, Domain> {
	...
	@Override
	protected ILookupStore<DomainModel, Long> getStore() {
		return store;
	}
}
