...
@TrackDetails
@Component
public class CreateBIReportUserBroker extends OPFSaveBroker<BIReportUserModel, BIReportUser, BIReportUser> {
    ...
    protected String getSuccessMessage(boolean isNew) {
        return "BI Report User has been created successfully.";
    }
