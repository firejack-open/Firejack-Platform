...
@TrackDetails
@Component("deleteSystemUserBroker")
public class DeleteSystemUserBroker extends DeleteBroker<SystemUserModel> {
	...
	protected String getSuccessMessage() {
		return "System User has deleted successfully";
	}

	@Override
	protected IStore<SystemUserModel, Long> getStore() {
		return store;
	}
}
