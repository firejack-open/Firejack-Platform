...
@TrackDetails
@Component("readRelationshipListBroker")
public class ReadRelationshipListBroker extends ReadAllBroker<RelationshipModel, Relationship> {

	@Autowired
	private IRelationshipStore store;

	@Override
	protected ILookupStore<RelationshipModel, Long> getStore() {
		return store;
	}
}
