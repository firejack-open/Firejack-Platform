...
@TrackDetails
@Component("createFilestoreBroker")
public class CreateFilestoreBroker extends SaveAliasableBroker<FileStoreModel, Filestore, RegistryNodeTree> {
	...
	protected String getSuccessMessage(boolean isNew) {
		return "Filestore has been created successfully.";
	}
