...
@TrackDetails
@Component("readResourceLocationListByRegistryNodeBrokerEx")
public class ReadResourceLocationListByRegistryNodeBroker extends ListBroker
    ...
    protected List<ResourceLocationModel> getModelList(ServiceRequest<NamedValues<Object>> request)
        ...
        List<ResourceLocationModel> resourceLocations = store.findAllByParentIdsWithFilter(
                registryNodeIds, getFilter(), new Paging(start, limit));
