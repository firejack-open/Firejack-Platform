...
@Component("deleteImageResourceVersionBroker")
@TrackDetails
public class DeleteImageResourceVersionBroker
        extends AbstractDeleteResourceVersionBroker<ImageResourceModel, ImageResourceVersionModel, ImageResource> {
