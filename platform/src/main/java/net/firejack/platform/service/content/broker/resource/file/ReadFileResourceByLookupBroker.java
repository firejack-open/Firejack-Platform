...
@Component("readFileResourceByLookupBroker")
@TrackDetails
public class ReadFileResourceByLookupBroker
        extends AbstractReadResourceByLookupBroker<FileResourceModel, FileResourceVersionModel, FileResource> {
