...
@Component("readDocumentResourceByLookupBroker")
@TrackDetails
public class ReadDocumentResourceByLookupBroker
        extends AbstractReadResourceByLookupBroker<DocumentResourceModel, DocumentResourceVersionModel, DocumentResource> {
