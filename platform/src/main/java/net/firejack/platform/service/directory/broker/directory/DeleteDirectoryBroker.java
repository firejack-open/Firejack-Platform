...
@TrackDetails
@Component("deleteDirectoryBroker")
public class DeleteDirectoryBroker extends DeleteLookupModelBroker<DirectoryModel> {
	...
	protected String getSuccessMessage() {
		return "Directory has deleted successfully";
	}
