...
/**
 * Class encapsulates the functionality of actor deletion
 */
@TrackDetails
@Component("deleteActorBroker")
public class DeleteActorBroker extends DeleteRegistryNodeBroker<ActorModel> {
