...
@TrackDetails
@Component("deleteWizardBroker")
@Changes("'Wizard '+ name +' has been deleted'")
public class DeleteWizardBroker extends DeleteRegistryNodeBroker<WizardModel> {
	...
	protected String getSuccessMessage() {
		return "Wizard has deleted successfully";
	}

	@Override
	protected IRegistryNodeStore<WizardModel> getStore() {
		return store;
	}
