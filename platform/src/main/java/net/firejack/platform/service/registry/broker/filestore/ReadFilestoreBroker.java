...
@TrackDetails
@Component("readFilestoreBroker")
public class ReadFilestoreBroker extends ReadBroker<FileStoreModel, Filestore> {

	@Autowired
	private IFileStore store;

	@Override
	protected IStore<FileStoreModel, Long> getStore() {
		return store;
	}
}
