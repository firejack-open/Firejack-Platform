...
@TrackDetails
@Component("updateConfigBroker")
public class UpdateConfigBroker extends OPFSaveBroker<ConfigModel, Config, Config> {
	...
	protected String getSuccessMessage(boolean isNew) {
		return "Config has been updated successfully.";
	}
