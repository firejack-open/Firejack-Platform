...
@Component("deleteAudioResourceBroker")
@TrackDetails
public class DeleteAudioResourceBroker
        extends AbstractDeleteResourceBroker<AudioResourceModel> {
    ...
    @Override
    protected IResourceStore<AudioResourceModel> getStore() {
        return store;
    }

    @Override
    protected String getSuccessMessage() {
        return "Audio resource has deleted successfully";
    }
