...
@Component
@TrackDetails
public class UpdateLdapGroupBroker extends BaseLdapBroker<Group> {
    ...
    protected ServiceResponse<Group> performInternal(ServiceRequest<NamedValues<Object>> request, LdapServiceFacade ldapService) {
        ...
        try {
            ...
            ldapService.updateGroup(group);
            response = new ServiceResponse<Group>(group, "Group updated successfully.", true);
        } catch (Throwable e) {
