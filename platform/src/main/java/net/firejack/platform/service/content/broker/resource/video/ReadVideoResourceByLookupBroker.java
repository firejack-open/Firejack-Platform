...
@Component("readVideoResourceByLookupBroker")
@TrackDetails
public class ReadVideoResourceByLookupBroker
        extends AbstractReadResourceByLookupBroker<VideoResourceModel, VideoResourceVersionModel, VideoResource> {

    @Autowired
    @Qualifier("videoResourceStore")
    private IResourceStore<VideoResourceModel> resourceStore;
