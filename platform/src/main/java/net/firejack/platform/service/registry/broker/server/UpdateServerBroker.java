...
@TrackDetails
@Component("updateServerBroker")
public class UpdateServerBroker extends SaveAliasableBroker<ServerModel, Server, RegistryNodeTree> {
	...
	protected String getSuccessMessage(boolean isNew) {
		return "Server has been update successfully.";
	}
