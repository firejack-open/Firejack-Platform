...
@TrackDetails
@Component("restartSystemBroker")
public class RestartSystemBroker extends ServiceBroker<ServiceRequest, ServiceResponse> {
	...
	protected ServiceResponse perform(ServiceRequest request) throws Exception {
		localDeployPackageService.restart();
		return new ServiceResponse("Restart started", true);
	}
}
