...
@TrackDetails
@Component("readDirectoryListBroker")
public class ReadDirectoryListBroker extends ListBroker<DirectoryModel, Directory, NamedValues> {
	...
	protected List<DirectoryModel> getModelList(ServiceRequest<NamedValues> request) throws BusinessFunctionException {
		return store.findAllWithFilterWithoutFields(getFilter());
	}
}
