...
@TrackDetails
@Component("deleteReportBroker")
@Changes("'Report '+ name +' has been deleted'")
public class DeleteReportBroker extends DeleteRegistryNodeBroker<ReportModel> {
	...
	protected String getSuccessMessage() {
		return "Report has deleted successfully";
	}

	@Override
	protected IRegistryNodeStore<ReportModel> getStore() {
		return store;
	}
