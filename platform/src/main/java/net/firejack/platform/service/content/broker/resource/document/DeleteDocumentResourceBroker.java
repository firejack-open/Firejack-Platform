...
@Component("deleteDocumentResourceBroker")
@TrackDetails
public class DeleteDocumentResourceBroker
        extends AbstractDeleteResourceBroker<DocumentResourceModel> {
    ...
    @Override
    protected IResourceStore<DocumentResourceModel> getStore() {
        return store;
    }

    @Override
    protected String getSuccessMessage() {
        return "Document resource has deleted successfully";
    }
