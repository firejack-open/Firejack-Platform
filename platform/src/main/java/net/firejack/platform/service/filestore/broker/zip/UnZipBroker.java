...
@Component
@TrackDetails
public class UnZipBroker extends ServiceBroker<ServiceRequest<NamedValues>, ServiceResponse> {
	...
	protected ServiceResponse perform(ServiceRequest<NamedValues> request) throws Exception {
		...
		fileStore.unzip(stream, path);

		return new ServiceResponse("unzip successfully.", true);
