...
@TrackDetails
@Component("deleteNavigationElementBroker")
public class DeleteNavigationElementBroker extends DeleteRegistryNodeBroker<NavigationElementModel> {
    ...
    @Override
    protected IStore<NavigationElementModel, Long> getStore() {
        return navigationElementStore;
    }
