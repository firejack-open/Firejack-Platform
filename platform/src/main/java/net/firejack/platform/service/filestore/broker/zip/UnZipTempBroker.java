...
@Component
@TrackDetails
public class UnZipTempBroker extends ServiceBroker<ServiceRequest<NamedValues>, ServiceResponse<FileInfo>> {
	...
	protected ServiceResponse<FileInfo> perform(ServiceRequest<NamedValues> request) throws Exception {
        ...
        List<FileInfo> fileInfos = fileStore.unzipTemp(stream, path);

		return new ServiceResponse<FileInfo>(fileInfos, "unzip successfully.", true);
