...
@Component
@TrackDetails
public class CreateZipBroker extends ServiceBroker<ServiceRequest<NamedValues>, ServiceResponse> {
	...
	protected ServiceResponse perform(ServiceRequest<NamedValues> request) throws Exception {
		...
		fileStore.zip(streams,path);

		return new ServiceResponse("Create zip successfully.", true);
