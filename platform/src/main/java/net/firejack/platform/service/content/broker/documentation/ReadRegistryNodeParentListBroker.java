...
@TrackDetails
@Component("ReadRegistryNodeParentListBroker")
public class ReadRegistryNodeParentListBroker extends ServiceBroker<ServiceRequest<SimpleIdentifier<Long>>, ServiceResponse<Lookup>> {
