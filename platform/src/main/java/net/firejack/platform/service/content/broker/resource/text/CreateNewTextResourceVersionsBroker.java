...
@Component("createNewTextResourceVersionsBroker")
@TrackDetails
public class CreateNewTextResourceVersionsBroker
        extends AbstractCreateNewResourceVersionsBroker<TextResourceModel, TextResourceVersionModel, TextResource> {

    @Autowired
    @Qualifier("textResourceStore")
    private IResourceStore<TextResourceModel> textResourceStore;
