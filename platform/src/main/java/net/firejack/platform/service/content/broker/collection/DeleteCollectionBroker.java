...
@TrackDetails
@Component("deleteCollectionBroker")
public class DeleteCollectionBroker extends DeleteRegistryNodeBroker<CollectionModel> {
    ...
    @Override
    protected IStore<CollectionModel, Long> getStore() {
