...
@TrackDetails
@Revalidation
@Component("updatePackageBroker")
public class UpdatePackageBroker extends SaveBroker<PackageModel, Package, RegistryNodeTree> {
	...
	protected String getSuccessMessage(boolean isNew) {
		return "Package has been updated successfully.";
	}
	...
	protected void save(PackageModel model) throws Exception {
		store.save(model, null, null, true);
	}
}
